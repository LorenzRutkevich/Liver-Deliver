...
def attention_res_unet(input_shape=(128, 128, 1), num_classes=1, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu', kernel_initializer='he_normal', use_bias=False, dropout=True):
    inputs = Input(input_shape)
...
def att_res_unet_pp(input_shape=(128,128,1), dropout=0.2, batchnorm=True, filters=32, kernelsize=3, upsample_size=2):
